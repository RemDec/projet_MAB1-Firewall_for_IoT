...
Pour ce type de dispositif, on veut pouvoir définir des règles de filtrage en fonction de l'utilisateur qui se cache derrière un paquet ou un flux. Plusieurs schéma d'association existe, définissant ce à quoi un utilisateur correspond.  


\subsubsection{Pare-feu nouvelles génération}

\subsection{NAT par pare-feu}
