...
\begin{center}
\textit{\og Global  infrastructure  for  the  society,  enabling  advanced  services  by  inter-connecting (physical and virtual) things based on existing and evolving in-teroperable information and communication technologies. \fg}
\end{center}
...
\par Ces notions sont similaires à celles généralement mises en avant dans le domaine de la sécurité informatique. On peut cependant les affiner davantage en se restreignant au cadre un peu plus limité des équipements IoT et en tenant compte de leurs particularités. Ces grands axes sont les suivants \cite{Leloglu2017} \cite{Huichen2016} :\\
