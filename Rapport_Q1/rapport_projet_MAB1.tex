...
\begin{table}[!ht]
    ...
    \hline
		Niveau dans le système &  Exemples d'outils, protocoles et équipements y opérant\\
	\hline
...
\todo{Lire article protocoles existants et sec dans IoT}

\par RPL, utilisé pour le routage dans les réseaux de capteurs et utilisable dans un réseau 6LowPAN, propose également des mécanismes de protection. Il s'agit dans ce cas de garantir 
...
\minit{Le scan passif ou la prise d'empreintes}
...
%------------- PARE FEUX + IoT -------------
\section{Les pare-feux et l'IoT}
