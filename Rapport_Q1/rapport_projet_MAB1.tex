...
\begin{itemize}
\item[$\bullet$] \textbf{Module actif} : un thread est lancé
\item[$\bullet$]
\end{itemize}

\par Librairie et q/p
...
\subsubsection{Modules actifs et passifs - abstraction des logiciels}
